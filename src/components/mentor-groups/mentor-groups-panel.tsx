...
import { ImportMentorGroupsDialog } from "@/components/mentor-groups/import-mentor-groups-dialog";
      ...
      <CardHeader className="flex flex-row flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Assign one mentor and a roster per group. Academic team assignments
            stay separate.
          </p>
        </div>
        {canEdit && (
